...
<div id="verify_number"></div>
    ...
    <div id="home" class="tab-pane fade in active">
      <h3><font color="#CC00CC">Ganti harga <?php echo "$namaproduk"; ?></font></h3>
      ...
      <div class="col-sm-4">
        <input class="form-control" id="focusedInput" type="text" name="harga">
      </div>
    </div>
    	...
    	<?php 
    		if (isset($_POST['no'])) {
    			...
    			$update = "UPDATE produk set harga='$harga' where id_produk=$id_produk";
